...
#define DEF_LAN_DHCP_BEG	"192.168.10.2"
#define DEF_LAN_DHCP_END	"192.168.10.254"
#define DEF_LAN_MASK		"255.255.255.0"

#define DEF_WLAN_2G_CC		"US"
#define DEF_WLAN_5G_CC		"TW"
#define DEF_WLAN_2G_SSID	BOARD_PID "-HDJG"
#define DEF_WLAN_5G_SSID	BOARD_PID "-HDJG-5G"
#define DEF_WLAN_2G_GSSID	BOARD_PID "-G-HDJG"
#define DEF_WLAN_5G_GSSID	BOARD_PID "-G-HDJG-5G"
#define DEF_WLAN_2G_PSK		"WJzp4wcN"
#define DEF_WLAN_5G_PSK		"WJzp4wcN"

#define DEF_ROOT_PASSWORD	"pK6Ut3zx"
